    ...
    <section className="relative min-h-screen flex items-center pt-16 gradient-hero">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Headline with linear gradient */}
          <h1>
            <span className="text-4xl md:text-6xl font-bold mb-2 block animate-fade-in transition-all duration-300">
              Transform Your Mixes Into
            </span>
            <span className="text-4xl md:text-6xl font-bold block animate-fade-in transition-all duration-300 bg-gradient-to-r from-purple-400 via-violet-400 to-indigo-300 bg-clip-text text-transparent">
              Label-Ready Tracks
            </span>
          ...
          <div className="relative group inline-block animate-fade-in">
            <Button className="pulse-cta bg-purple-700 hover:bg-purple-800 text-white text-lg py-6 px-8 rounded-md transition-all duration-300 group-hover:scale-[1.02]">
